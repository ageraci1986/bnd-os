 ...
 * saisie. Le wrapper aria-live reste toujours monté (même en `idle`, où il
 * est vide) pour que les lecteurs d'écran annoncent fiablement la
 * transition idle→recording (VoiceOver notamment n'annonce pas de façon
 * fiable un live region monté avec du contenu déjà présent). aria-live
 * =polite : les changements d'état sont annoncés sans interrompre le
 * lecteur d'écran.
 */
